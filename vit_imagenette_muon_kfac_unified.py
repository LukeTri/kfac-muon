...
def parse_args() -> TrainConfig:
    ...
    parser.add_argument("--aux-no-decay", action="store_true")
    parser.add_argument("--log-json", type=str, default=None)

    parser.set_defaults(muon_nesterov=True, kfac_nesterov=True, separate_qkv=False)
    ...
    return TrainConfig(
        ...
        aux_no_decay=args.aux_no_decay,
